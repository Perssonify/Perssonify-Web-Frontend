...
const SpecializedGrowthSolutions: React.FC = () => {
  const solutions = [
    {
      ...
      link: '/deep-dive-audit-and-strategic-insights',
      icon: SearchCheck
    },
    {
      ...
      link: '/analytics-and-event-tracking-setup',
      icon: BarChart3
    },
    {
      ...
      link: '/lead-generation-and-funnel-strategy',
      icon: Funnel
    },
    {
      ...
      link: '/brand-architecture-and-strategy',
      icon: Building
    },
    {
      ...
      link: '/content-strategy-and-planning',
      icon: FileText
    },
    {
      ...
      link: '/ai-accelerated-content-production-pipelines',
      icon: Cpu
    },
    {
      ...
      link: '/executive-personal-branding-and-linkedin-marketing',
      icon: UserCheck
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background w-full px-4 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <motion.div
                ...
                className="bg-card border border-border rounded-2xl p-8 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 cursor-pointer"
              >
                ...
                <Button
                  asChild
                  className="bg-primary text-primary-foreground hover:bg-primary/90 focus:ring-2 focus:ring-primary focus:ring-offset-2 border-none shadow-none w-fit"
                  size="lg"
                >
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 dark:bg-muted/40 bg-muted/70 rounded-2xl mb-20">
