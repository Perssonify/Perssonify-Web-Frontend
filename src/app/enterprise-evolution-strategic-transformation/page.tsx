  ...
  return (
    <>
      ...
      <section className="max-w-3xl mx-auto px-4 pb-16">
        <h2 className="text-xl sm:text-2xl font-semibold text-primary mb-3 mt-10">When to Apply</h2>
        <ul className="list-disc pl-6 mb-8 space-y-2 text-foreground">
          <li>When leadership knows change is needed but clarity is lacking on where to begin or what to prioritize.</li>
          <li>When growth is limited by operational constraints, outdated structures, or internal friction.</li>
          <li>When organizations are entering a new phase—scaling, restructuring, or integrating after M&amp;A activity.</li>
          <li>When new revenue streams or innovation goals require a new go-to-market approach or cross-functional realignment.</li>
        </ul>
        <h2 className="text-xl sm:text-2xl font-semibold text-primary mb-3">Why It Matters</h2>
        <ul className="list-disc pl-6 space-y-2 text-foreground">
          <li>Businesses that fail to evolve become slow, reactive, and strategically irrelevant.</li>
          <li>Clear transformation strategies ensure that change efforts are aligned, resourced, and measurable.</li>
          <li>Perssonify helps reduce the risk of transformation by combining big-picture thinking with execution-focused support.</li>
          <li>We ensure organizations don&apos;t just plan to change—they actually move forward with confidence and clarity.</li>
        </ul>
      </section>
    </>
  );
