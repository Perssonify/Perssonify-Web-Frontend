        ...
        <div className="container max-w-6xl mx-auto">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl lg:text-6xl font-bold font-playfair text-black dark:text-white mb-6 lg:mb-8">
              We bring{" "}
              <span className="bg-gradient-to-br from-primary to-accent bg-clip-text text-transparent drop-shadow-md text-stroke-themed">
                Growth
              </span>{" "}
              and{" "}
              <span className="bg-gradient-to-br from-primary to-accent bg-clip-text text-transparent drop-shadow-md text-stroke-themed">
          ...
          <div className="container max-w-6xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
              {solvepathSteps.map((step) => (
                <Card
                  key={step.title}
                  className="text-center bg-gradient-to-br from-primary/10 to-primary/5 border-0 custom-shadow"
                >
        ...
        <section className="py-24 bg-muted/30">
          <div className="container max-w-6xl">
            ...
            <div className="grid gap-y-12 gap-x-8 sm:grid-cols-2 lg:grid-cols-4">
              {people.map((person) => (
                <Card key={person.id} className="text-center p-6 h-full">
