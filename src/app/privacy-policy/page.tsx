    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto pt-24 pb-16">
        ...
        >
          ...
          <div className="prose prose-lg prose-relaxed max-w-none text-muted-foreground space-y-10 dark:prose-invert leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">2. Information We Collect</h2>
              
              <h3 className="text-xl font-medium text-foreground mb-4">2.1 Personal Information</h3>
              <p className="text-muted-foreground leading-loose mb-6">We may collect the following types of personal information:</p>
              ...
              <h3 className="text-xl font-medium text-foreground mb-4">2.2 Automatically Collected Information</h3>
              <ul className="list-disc pl-6 text-muted-foreground mb-8 space-y-3 leading-loose">
              ...
              <h3 className="text-xl font-medium text-foreground mb-4">2.3 Third-Party Information</h3>
              <p className="text-muted-foreground leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">3. How We Use Your Information</h2>
              <p className="text-muted-foreground leading-loose mb-6">We use your information for the following purposes:</p>
              <ul className="list-disc pl-6 text-muted-foreground mb-8 space-y-3 leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">4. Legal Basis for Processing</h2>
              <p className="text-muted-foreground leading-loose mb-6">We process your personal information based on the following legal grounds:</p>
              <ul className="list-disc pl-6 text-muted-foreground mb-8 space-y-3 leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">5. Information Sharing and Disclosure</h2>
              <p className="text-muted-foreground leading-loose mb-6">We may share your information in the following circumstances:</p>
              
              <h3 className="text-xl font-medium text-foreground mb-4">5.1 Service Providers</h3>
              <p className="text-muted-foreground leading-loose mb-6">
              ...
              <h3 className="text-xl font-medium text-foreground mb-4">5.2 Business Transfers</h3>
              <p className="text-muted-foreground leading-loose mb-6">
              ...
              <h3 className="text-xl font-medium text-foreground mb-4">5.3 Legal Requirements</h3>
              <p className="text-muted-foreground leading-loose mb-6">
              ...
              <h3 className="text-xl font-medium text-foreground mb-4">5.4 Consent</h3>
              <p className="text-muted-foreground leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">6. Cookies and Tracking Technologies</h2>
              <p className="text-muted-foreground leading-loose mb-6">
              ...
              <h3 className="text-xl font-medium text-foreground mb-4">Types of Cookies We Use:</h3>
              <ul className="list-disc pl-6 text-muted-foreground mb-8 space-y-3 leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">7. Data Security</h2>
              <p className="text-muted-foreground leading-loose mb-6">
                We implement appropriate technical and organizational security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. These measures include:
              </p>
              <ul className="list-disc pl-6 text-muted-foreground mb-6 space-y-3 leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">8. Data Retention</h2>
              <p className="text-muted-foreground leading-loose mb-6">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">9. Your Rights and Choices</h2>
              <p className="text-muted-foreground leading-loose mb-6">Depending on your location, you may have the following rights regarding your personal information:</p>
              <ul className="list-disc pl-6 text-muted-foreground mb-6 space-y-3 leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">10. International Data Transfers</h2>
              <p className="text-muted-foreground leading-loose mb-6">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">11. Children&apos;s Privacy</h2>
              <p className="text-muted-foreground leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">12. Third-Party Links and Services</h2>
              <p className="text-muted-foreground leading-loose">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">13. Changes to This Privacy Policy</h2>
              <p className="text-muted-foreground leading-loose mb-6">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">14. Contact Information</h2>
              <p className="text-muted-foreground leading-loose mb-6">
                If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us:
              </p>
              <div className="bg-muted/50 p-6 rounded-lg">
                <p className="text-foreground font-medium">Perssonify Privacy Team</p>
                <p className="text-muted-foreground">Email: <a href="mailto:privacy@perssonify.com" className="underline text-primary">privacy@perssonify.com</a></p>
              ...
              <p className="text-muted-foreground leading-loose mt-6">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-foreground mb-6">15. Effective Date</h2>
              <p className="text-muted-foreground leading-loose">
