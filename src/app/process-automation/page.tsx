  ...
  const services = [
    {
      ...
      description:
        "Evaluate current processes to identify repetitive, error-prone, or high-cost tasks suitable for automation.",
    },
    {
      icon: Settings,
      ...
      description:
        "Build scalable, logic-driven workflows that align with business rules and are easy to adapt over time.",
    },
    {
      icon: Zap,
      ...
      description:
        "Automate repetitive steps using bots and intelligent decisioning systems that route tasks based on data inputs.",
    },
    {
      icon: CheckCircle,
      ...
      description:
        "Coordinate automated and human-in-the-loop steps to ensure end-to-end process flow across platforms.",
    },
  ];
