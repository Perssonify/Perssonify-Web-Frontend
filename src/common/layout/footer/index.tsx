...
const Footer: React.FC = () => {
  ...
  const solutions = {
    coreGrowth: [
      { name: 'Performance Marketing & Paid Media', href: '/performance-marketing' },
      { name: 'Social Media Marketing & Brand Engagement', href: '/social-media-marketing' },
      { name: 'Email Marketing & Marketing Automation', href: '/email-marketing' },
      { name: 'Creative Solutions', href: '/creative-solutions' },
      { name: 'Conversion Rate Optimization (CRO)', href: '/conversion-optimization' },
    ...
    specializedGrowth: [
      ...
      { name: 'Analytics and Event Tracking Setup', href: '/analytics-tracking' },
    ...
    coreStrategic: [
      ...
      { name: 'Digital Systems Enablement', href: '/digital-systems-enablement' },
      { name: 'Custom Solution Engineering', href: '/custom-solution-engineering' },
      { name: 'Enterprise Evolution & Strategic Transformation', href: '/enterprise-evolution' },
    ],
    strategicByFunction: [
      ...
      { name: 'Cross-Functional Leadership', href: '/cross-functional-leadership' },
    ...
    <footer className="border-t bg-background text-foreground">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-5 max-w-6xl mx-auto pl-2 sm:pl-4">
          ...
          {/* Navigation */}
          <div className="space-y-3">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-primary">Company</h3>
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-primary">Growth Solutions</h3>
            <ul className="space-y-1">
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-primary">Specialized Solutions</h3>
            <ul className="space-y-1">
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-primary">Strategic Solutions</h3>
            <div className="space-y-2">
              <div>
